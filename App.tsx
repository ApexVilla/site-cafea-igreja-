...
const App: React.FC = () => {
    ...
    <>
      ...
      <section id="inicio" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 max-w-6xl">
          <Logo size={140} className="mx-auto mb-10 logo-shadow animate-pulse" />
          <h1 className="text-5xl md:text-8xl text-white mb-6 leading-tight uppercase font-bold tracking-tight">
            CONVENÇÃO <span className="text-church-gold italic font-serif">CAFEIA</span>
          </h1>
            ...
            {CHURCHES.map((church) => (
              <div key={church.id} className="group bg-white rounded-[40px] overflow-hidden shadow-xl border border-transparent hover:border-church-gold transition-all duration-500 flex flex-col">
                ...
                <div className="p-8 flex-1 flex flex-col justify-between">
                  ...
                  <button
                    onClick={() => { setSelectedChurch(church); window.scrollTo(0, 0); }}
      ...
      <section id="midias" className="py-32 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl text-church-purple font-serif uppercase mb-4">Feed <span className="text-church-gold">CAFEIA</span></h2>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              A CAFEIA não é apenas um grupo de igrejas, é uma família ministerial. Nossa missão é oferecer suporte, cobertura espiritual e treinamento para pastores e líderes, sempre focados no acolhimento e na transformação genuína.
            </p>
  ...
  // Church Profile View
  const ChurchProfileView = ({ church }: { church: Church }) => (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-20">
          ...
          <div className="space-y-10">
            <div className="bg-church-purple p-10 rounded-[40px] text-white shadow-2xl relative overflow-hidden group">
              ...
              <button
                onClick={() => handleWhatsApp(church.whatsapp)}
  ...
  return (
    <div className="min-h-screen bg-church-offwhite text-slate-800">
      {/* Platform Navigation */}
          ...
          <div className="flex justify-between items-center">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs md:text-sm font-sans tracking-[0.3em] uppercase text-church-silver font-semibold">Cafeia</span>
              </div>
            </div>
      ...
      {selectedChurch ? (
        <ChurchProfileView church={selectedChurch} />
      ) : (
        <MainView />
      )}
      ...
      <footer className="bg-church-purple text-white pt-24 pb-12 px-4 relative overflow-hidden">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm tracking-[0.5em] uppercase text-church-silver font-bold">Cafeia</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-white/30 uppercase tracking-[0.3em] font-bold">
          <p>© 2024 CONVENÇÃO CAFEIA | PLATAFORMA INTEGRADA</p>
